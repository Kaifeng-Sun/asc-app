          ...
          <Grid templateColumns="repeat(2, 1fr)" gap={2}>
            <GridItem w="200%">
              ...
              > <br/>
                  ...
                  Events, all conducted on self-funded basis. 
                  <br/> <br/>
                  As interest in these activities grew, the need to have larger, more suitable, premises became
                  ...
                  the range and frequency of its activities. 
                  <br/> <br/>
                  Its membership has also
